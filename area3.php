...
<header class="bg-green-600 text-white p-4 shadow flex justify-between items-center">
    ...
    <h1 class="text-2xl font-bold">Area III: Curriculum and Instruction</h1>
            ...
            <?php foreach($documents as $i => $doc): ?>
                <tr class="<?= $i % 2 === 0 ? 'bg-green-50' : '' ?>">
                    ...
                    <td class="border px-4 py-2 flex gap-2">
                        ...
                        <a href="edit3.php?id=<?= $doc['doc_id'] ?>"
                           class="bg-yellow-500 hover:bg-yellow-600 text-white px-2 py-1 rounded">
                           Edit
                        </a>

                        <a href="area3.php?delete_id=<?= $doc['doc_id'] ?>"
