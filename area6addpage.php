...
if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['doc_file']) && $_FILES['doc_file']['error'] === 0) {
        ...
        if (move_uploaded_file($_FILES['doc_file']['tmp_name'], $targetFile)) {
            ...
            if ($stmt->execute()) {
                echo "<script>alert('Document successfully added'); window.location='viewdocs.php';</script>";
            } else {
...
<div class="max-w-lg mx-auto mt-10 bg-white p-6 rounded-xl shadow">
  ...
  <form method="POST" enctype="multipart/form-data" class="space-y-5">
    ...
    <div class="flex justify-end gap-3 pt-4">
      <a href="area6.php" class="px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">Cancel</a>
